...
class ProductBloc extends Bloc<ProductEvent, ProductState> {
  ...
  ProductBloc({
    ...
    _categorySubscription = _categoryBloc.stream.listen((state) {
      if (state is CategoryLoaded && state.selectedCategory != null) {
        ...
        // Handle the case when the category is null or in an unexpected state
      }
    });
    ...
    _restaurantSubscription = _restaurantRepository.getRestaurant().listen(
      (restaurant) {
        if (restaurant.products != null) {
          ...
          // Handle the case when restaurant.products is null
        }
      },
    );
  }
  ...
  void _onSortProducts(
    ...
    try {
      ...
      // Handle the case when an error occurs during sorting
    }
  }
